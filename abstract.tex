...
However, since these devices collect very personal data, there are substantial
privacy concerns about their use.  As such researchers must go through 
a detailed IRB process before recruiting users or collecting data.
As such, many research studies either do not use data from real users or use
...
means (not just as a stated policy) by a set of 
\textit{blurring layers}. Different policies 
can be created by loading individual blurring layers in order, 
as a \textit{policy stack}. \cappos{Why is this relevant here?}
...
experiment infrastructure \cappos{What is the point of this?  Are we off 
topic?}, and saves researchers' 
effort in recruiting participants and managing a deployment. \cappos{The
sentence before this needs to be tightened.  It mentions all sorts of things
we don't really cover in the paper.}
