...
and tablets could be of tremendous value to the research 
community. Their potential has sparked a number 
of recent research initiatives, such as investigating end-user 
traffic patterns, etc. However, the expanded use of mobile 
devices has resulted in increased privacy and security break-ins 
on these devices. As a result, few researchers use mobile testbeds 
as their research platform. The question remains whether research on 
...
Through the use of a secure sandbox, data can be gathered 
...
experiment code and infrastructure, and saves researchers' effort in
