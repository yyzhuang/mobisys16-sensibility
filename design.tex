...
Sensibility Testbed uses a sandbox that provides security isolation.
...
This sandbox is called Repy (Restricted Python)\footnote{\scriptsize This is the 
...
has a small, self-contained kernel as its trusted 
...
and avoid uncommon corner cases that can be exploited. 
...
resources on a device. Over the past 6 years, we have used the 
