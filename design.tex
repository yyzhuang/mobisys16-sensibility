...
%Suppose a device owner Alice installs the Sensibility Testbed app. 
When the app is started on Alice's device, her devices can be 
...
itself to Sensibility Testbed. \yanyan{add lookup service in Fig 1?}
