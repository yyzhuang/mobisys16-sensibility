...
There are three software components on the devices in Sensibility 
...
Two usage scenarios further illustrating how the components operate, 
...
Alice's app uses an \textit{identification key}, \path{key.alice} and 
...
clearinghouse obtains \path{key.alice} generated during the app 
installation. 
