...
To conduct an experiment on Sensibility Testbed, a researcher first 
...
\yanyan{is this better be placed in scenario 2?}
...
an \textit{identification key}, \path{key.alice} (see usage scenario 2 
...
\yanyan{a question for Justin: I think the device first puts key.sensibility 
