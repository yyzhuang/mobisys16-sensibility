...
Alice wants to allow scientists to perform experiements using her device.
...
To conduct an experiment, Bob first fills out a form at a \sysname website 
...
each sensor. Bob then downloads documents to provide to his IRB that 
explains the details about his experiment, \sysname and the technical 
restrictions his experiment will have. Bob then goes through the IRB process at 
his institution, provides his institution's IRB policies to the 
\sysname website, and sign up for his experiment. 

The form that Bob previously filled out on the \sysname website is used to
...
in his experiment being blocked from reading the roaming status and cell 
...
Note that the policies have limits to the precision of data that Bob can request
