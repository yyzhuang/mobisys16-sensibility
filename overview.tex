...
should justify this, and what about risk 3? in 5.1 we say: Note that specific details 
as to how frequently a certain sensor can be accessed without risking such an 
...
Sensibility Testbed involves three types of interacting
...
experiments on mobile devices. Our design follows
...
The last design principle \jill{not sure if this is a principle...maybe we should rename this section}
was to allow researchers to manage their 
