...
(Section~\ref{sec-repy}). This section described how Repy provides
...
breaches or operational fault. \yanyan{Justin thinks this statement is weak.}
...
\path{get_accelerometer}. That is, the function on the left of \texttt{:}
...
the city level. This is because layers \path{blur_to_city} and 
