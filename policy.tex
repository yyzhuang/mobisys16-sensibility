...
lookup. \path{get_location()} thus %is defined in the namespace of the sandbox kernel, it 
...
%\vspace*{-20pt}
\caption{\small Sensibility Testbed blur policies. \yanyan{maybe replot}
\label{fig-blur}}
\end{figure}
...
In a policy stack, each blurring layer is an isolated and contained reference 
...
\path{get_accelerometer}: i.e., the function on the left of \texttt{:}
...
in a similar way as reducing the data precision.
