...
\subsubsection{Sensor Access from the Python Sandbox}\lois (why not call it the Repy Sandbox as before?)
...
Repy's own programming language, such as \path{get_location()}, 
...
can be directly used in an experiment program. \lois(why is this important? And used how?)
%if no blurring layer is in place.
